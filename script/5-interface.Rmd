...
Goal for today is focus on the interface of functions, because I think this is an important change in mindset when you start developing functions. You have to think how they fit together into a great whole.

**Your turn**: What are the properties of a function that define its interface?
...
**Your turn**: What are some of the challenges of the base string functions?
...
Verbs aren't always essential, and nouns can work when you're building up objects
...
```{r}
install.packages(Ncpus=, configure.vars =, keep_outputs=, INSTALL_opts=, contriburl=)
```

### Types

**Your turn**: Can divide the following into functional groups?
